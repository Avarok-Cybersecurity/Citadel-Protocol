...
async fn drive(
    ...
    let final_candidate_tx = &mut lock_wrapper::Mutex::new(Some(final_candidate_tx));
    ...
    let loser_value_set = &lock_wrapper::Mutex::new(None);
    ...
    let finished_count = &lock_wrapper::Mutex::new(0);
    ...
    let done_tx = lock_wrapper::Mutex::new(Some(done_tx));
