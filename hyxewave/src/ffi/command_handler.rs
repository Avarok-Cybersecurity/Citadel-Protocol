...
fn handle_ffi_payload(server_remote: &HdpServerRemote, ctx: &ConsoleContext, ffi_io: FFIIO, input: &str, rt_handle: &Handle) -> Result<Option<KernelResponse>, ConsoleError> {
