...
use criterion::{Bencher, black_box, Criterion, ParameterizedBenchmark, Throughput};
use rand::{FromEntropy, Rng};

use base64::{
    Config, decode, decode_config_buf, decode_config_slice, encode, encode_config_buf,
