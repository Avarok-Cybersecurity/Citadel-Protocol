...
pub struct ServicesHandler {
    ...
    /// Serverside only
    pub rtdb_config: Option<crate::external_services::service::RtdbConfig>,
}
...
pub struct ServicesConfig {
    ...
    pub google_rtdb: Option<crate::external_services::service::RtdbConfig>,
}
...
pub mod service {
    ...
    impl crate::external_services::ServicesConfig {
        ...
        pub async fn into_services_handler(self) -> Result<crate::external_services::ServicesHandler, AccountError> {
