...
import com.satori.verisend.MainActivity;
...
public class FirebaseHandler extends FirebaseMessagingService {
    ...
    public void onNewToken(String token) {
        Log.wtf(TAG, "[FCM] Refreshed token: " + token);
    ...
    private void sendNotification(String messageBody) {
        ...
        /*
        VerisendService.getGlobalInstance()
                .ifPresent((svc) -> {
                    svc.pushNotification("FCM Message", messageBody, Optional.of(pendingIntent));
                });*/
    }
}