...
pub async fn process_deregister<R: Ratchet, I: CitadelIOInterface>(
...
async fn deregister_client_from_self<R: Ratchet, I: CitadelIOInterface>(
    session_cid: u64,
    session_ref: &CitadelSession<R, I>,
    ratchet: &R,
    timestamp: i64,
...
async fn deregister_from_hyperlan_server_as_client<R: Ratchet, I: CitadelIOInterface>(
    session_cid: u64,
    session_ref: &CitadelSession<R, I>,
) -> Result<PrimaryProcessorResult, NetworkError> {
    let session = session_ref;
