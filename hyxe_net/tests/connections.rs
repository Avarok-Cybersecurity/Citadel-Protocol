...
pub mod tests {
    ...
    fn protocols() -> Vec<UnderlyingProtocol> {
        ...
        vec![
            ...
            UnderlyingProtocol::load_tls_from_bytes(&pkcs_12_der, "password", "thomaspbraun.com")
                .unwrap(),
            UnderlyingProtocol::load_quic_from_bytes(&pkcs_12_der, "password", "thomaspbraun.com")
                .unwrap(),
        ]
    }
