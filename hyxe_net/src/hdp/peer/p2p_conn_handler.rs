...
use crate::hdp::outbound_sender::{unbounded, OutboundPrimaryStreamReceiver, UnboundedSender};
...
pub(crate) async fn attempt_simultaneous_hole_punch(
    ...
    let process = async move {
        ...
        if is_initiator {
            ...
            let quic_endpoint =
                hyxe_wire::quic::QuicClient::new_with_config(socket, client_config.clone())
                    .map_err(generic_error)?;
