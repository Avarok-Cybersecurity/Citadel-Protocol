...
pub struct NetRwLock<T: NetObject, S: Subscribable + 'static> {
    ...
    local_active_read_lock: Arc<citadel_runtime::RwLock<Option<OwnedLocalReadLock<T>>>>,
...
impl<T: NetObject, S: Subscribable + 'static> NetRwLock<T, S> {
    pub async fn new_internal(
        ...
        let this = Self {
            ...
            local_active_read_lock: Arc::new(citadel_runtime::RwLock::new(None)),
...
pub(crate) mod read {
    ...
    pub struct NetRwLockReadGuard<T: NetObject + 'static, S: Subscribable + 'static> {
        ...
        shared_store: Arc<citadel_runtime::RwLock<Option<OwnedLocalReadLock<T>>>>,
    }
...
async fn passive_background_handler<S: Subscribable + 'static, T: NetObject>(
    ...
    read_lock_local: Arc<citadel_runtime::RwLock<Option<OwnedLocalReadLock<T>>>>,
) -> Result<(), anyhow::Error> {
